        ...
        <form className="grid grid-cols-1 gap-5 mt-8">
          ...
          <div className="flex gap-2">
            <div className="text-sm md:text-lg">
              <PiBuildingOfficeDuotone color="#6315db" />
            </div>
            <input
              type="text"
              name="companyName"
          ...
          <div className="space-y-2 flex gap-2">
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <button
                ...
                className="block mr-auto text-[#6315db] text-sm font-medium hover:text-[#5111b3] transition-all duration-300 ease-in-out cursor-pointer"
              >
                + Add another phone
              </button>
            </div>
          ...
          {/* Email */}
          <div className="flex gap-2">
            <div className="text-sm md:text-lg"><AiTwotoneMail color="#6315db"/></div>
            <input
              type="email"
              name="companyEmail"
          ...
          <select
            name="category"
            className="text-[#07020D] border w-full px-3 py-2 md:p-3 outline-none focus:outline-none focus:ring-0 focus:border focus:border-[#6315db] rounded"
            required
          >
