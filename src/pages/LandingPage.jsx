          ...
          <div className="absolute top-0 left-0 right-0 bottom-0 w-full h-full pt-36">
            <div className="container mx-auto flex flex-col items-center py-2">
              ...
              <div className="flex mt-5 w-full justify-center items-center flex-col md:flex-row gap-5 md:gap-8 font-semibold text-md">
                ...
                <Link to={"/auth"} state={{ backgroundLocation: location }} className="py-2 px-10 border border-[#6315db] rounded-lg hover:bg-[#6315db] transition duration-300 ease-in-out -skew-x-14 cursor-pointer"><ShinyText text="Try it Now" disabled={false} speed={3} className="custom-class"/></Link>
              </div>

              <img src={images.backwythFlowcChart} alt="flow-chart" className="py-6 px-4 lg:w-[62%]"/>
            </div>
          </div>
      </div>     
    </section>
